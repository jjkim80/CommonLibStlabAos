...
public class RetrofitLogInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (logHeaders) {
            if (hasRequestBody) {
                if (com.dkitec.commonlib_stalb_aos.utils.Logger.isRequestHeaderLog) {
...
//                    if (!Constants.HEADER_CONTENT_TYPE.equalsIgnoreCase(name) && !"Content-Length".equalsIgnoreCase(name)) {
...
//                logger.log("");
        ...
        if (logHeaders) {
            if (com.dkitec.commonlib_stalb_aos.utils.Logger.isResponseHeaderLog) {
